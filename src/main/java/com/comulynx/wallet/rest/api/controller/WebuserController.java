...
public class WebuserController {
	...
	public ResponseEntity<?> createWebuser(@RequestBody Webuser webuser) {
		try {
			...
			Optional<Webuser> webUser= webuserRepository.findByUserNameOrEmailOrEmployeeIdOrcustomerId( userName,  email,  employeeId,  customerId);
       
			if (webUser.isPresent()) {
				throw new Exception ("This "+webUser+" alreafy exist");
			}
